...
function PythonBootcampLanding() {
  ...
  return (
    <div>
      ...
      <section className="section1">
        <h1 className="mhead white martop-35">Python Bootcamp</h1>
        <br />
        <p className="phead martop-15 white">
          Get trained by Industry Experts with <br />
...
export default PythonBootcampLanding;
