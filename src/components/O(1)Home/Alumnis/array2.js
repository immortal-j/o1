const arr2 = [
  {
    ...
    image: "images/Vishal Kriplani-min.png",
  },
  {
    id: 8,
    ...
    description1:
      "I took part in Coding Premier League and multiple Competitive Coding Streak contests organised by O(1) Coding Club.Before attending those events I was not able to solve even very simple",
    description2:
    ...
    image: "images/Sudhanshu Bhogal-min.png",
  },
  {
    id: 9,
    name: "Yavar Vazir",
  ...
  },
  {
    ...
    description1:
      "I attended the React.js workshop by O(1) Coding Club in Jan. It was a really informative, interactive and organized workshop.Everything was developed from scratch with proper stepwise explanation",
    description2: ".I would highly recommend O(1) Workshops.",
    linkedin: "https://www.linkedin.com/in/rajat-bhanarkar-11a859176",
    image: "images/Rajat Bhanarkar-min.png",
  },
  {
    id: 11,
    name: "Nidhi Sharma",
    ...
    image: "images/Nidhi Sharma-min.png",
  },
];
export default arr2;
