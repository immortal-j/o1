var arr = [
  {
    ...
    name: "CodeRun",
    description1:
      "Designed to uplift one's coding skills to ease through various placement hurdles like coding rounds, interviews etc",
    description2:
  ...
  },
  {
    ...
    description1:
      "Let's make coding super fun with friendly teammates, experienced coaches, gritty training nets & thrilling matches",
    description2:
  ...
  },
  {
    ...
    name: "Workshops",
    description1:
      "Add a skill and upgrade your inventory with some amazing projects, all made by you, guided by us within just a week's time!! Perfect for all beginners as well as experts",
    description2:
  ...
  },
  {
    ...
    name: "Bootcamps",
    description1:
      "Learn from scratch and get comfortable with a 15-20 days Bootcamp covering all basic to advanced concepts",
    description2:
  ...
  },
  {
    ...
    name: "Internship",
    description1:
      "A final touch to your master piece. This is what separates a leader from the herd.",
    description2:
      "An opportunity for the young enthusiasts to work on live projects under O(1) Coding Club. Understand industry requirements, experience, expertise.",
    lottiefile: "TrophyMake",
  },
];
export default arr;
